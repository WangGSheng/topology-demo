...
import { dqgc } from '../selfData/dqgc.js';
import { gjdw } from '../selfData/gjdw';
...
export const defalutMaterials = [
    ...
    list: [
      {
        name: '地图',
        id: 100,
        image: 'images/global_map.png'
      },
      {
        name: '水池', // 工具栏提示文字
        icon: 't-icon t-rect', // 工具栏显示字体图标
        data: {
  ...
  { name: '常用图标', expand: false, show: true, list: cytb },
  { name: '电气工程常用字母和符号', expand: false, show: true, list: dqgc },
  { name: '国家电网图元规范', expand: false, show: true, list: gjdw }
];
