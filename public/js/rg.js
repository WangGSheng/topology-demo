!(function(t, r) {
  ...
  return (function(t) {
      ...
      o('inspectSource', function(t) {
        ...
        (t.exports = function(t, r, n, o) {
          var a = !!o && !!o.unsafe,
            ...
            s = !!o && !!o.noTargetGet;
          'function' == typeof n &&
            ('string' != typeof r || u(n, 'name') || i(n, 'name', r),
            (l(n).source = p.join('string' == typeof r ? r : ''))),
            t !== e
              ? (a ? !s && t[r] && (f = !0) : delete t[r],
                f ? (t[r] = n) : i(t, r, n))
              : f
              ? (t[r] = n)
              : c(r, n);
      ...
      (f || s) &&
        (a = function(t) {
          var r,
            ...
            a = this;
          return (
            s && (n = new RegExp('^' + a.source + '$(?!\\s)', i.call(a))),
            f && (r = a.lastIndex),
            (e = u.call(a, t)),
            f && e && (a.lastIndex = a.global ? e.index + e[0].length : r),
            s &&
              e &&
              e.length > 1 &&
    ...
    function(t, r, n) {
      ...
      var e = n(9),
        ...
        it = function(t, r, n) {
          ...
          return (
            ...
            f(J, e)
              ? (n.enumerable
                  ? (f(t, C) && t[C][e] && (t[C][e] = !1),
                    (n = d(n, { enumerable: h(0, !1) })))
                  : (f(t, C) || B(t, C, h(1, {})), (t[C][e] = !0)),
                nt(t, e, n))
              : B(t, e, n)
          );
        },
        ...
        ct = function(t) {
          ...
          return (
            !(this === $ && f(J, r) && !f(X, r)) &&
            (!(n || !f(this, r) || !f(J, r) || (f(this, C) && this[C][r])) || n)
          );
        },
        at = function(t, r) {
          var n = y(t),
          ...
          if (n !== $ || !f(J, e) || f(X, e)) {
            var o = Y(n, e);
            return (
              !o || !f(J, e) || (f(n, C) && n[C][e]) || (o.enumerable = !0), o
            );
          }
        },
        ft = function(t) {
      ...
      c ||
        (I(
          (U = function() {
            ...
            var t =
              ...
              n = function(t) {
                this === $ && n.call(X, t),
                  f(this, C) && f(this[C], r) && (this[C][r] = !1),
                  nt(this, r, h(1, t));
              };
            return u && rt && nt($, r, { configurable: !0, set: n }), et(r, t);
          }).prototype,
          'toString',
          function() {
            return V(this).tag;
        ...
        (S.f = st),
        u &&
          (B(U.prototype, 'description', {
            configurable: !0,
            get: function() {
              return V(this).description;
            }
          }),
          i || I($, 'propertyIsEnumerable', ct, { unsafe: !0 })),
        (_.f = function(t) {
          return et(N(t), t);
        })),
        e({ global: !0, wrap: !0, forced: !c, sham: !c }, { Symbol: U }),
        k(x(Z), function(t) {
          L(t);
        }),
        e(
        ...
        U.prototype[G] || j(U.prototype, G, U.prototype.valueOf),
        R(U, 'Symbol'),
        (P[C] = !0);
    },
    function(t, r, n) {
    ...
    function(t, r, n) {
      n(9)({ target: 'Array', stat: !0 }, { isArray: n(28) });
    },
    function(t, r, n) {
      'use strict';
      var e = n(9),
        ...
        if (
          (P &&
            ...
            y !== Object.prototype &&
              ...
              (l ||
                i(m) === y ||
                (u ? u(m, y) : 'function' != typeof m[h] && a(m, h, d)),
              c(m, A, !0, !0),
              l && (p[A] = d))),
          'values' == v &&
            M &&
          ...
          else e({ target: r, proto: !0, forced: g || j }, S);
        return S;
      };
    },
    function(t, r, n) {
        ...
        { target: 'Array', proto: !0, forced: !s('slice') },
        {
          slice: function(t, r) {
            ...
            if (
              ...
              return p.call(y, h, d);
            for (
              e = new (void 0 === n ? Array : n)(v(d - h, 0)), s = 0;
              h < d;
              h++, s++
            )
              h in y && f(e, s, y[h]);
        ...
        return [
          ...
          function(t, i) {
            ...
            for (var m, S = '', w = 0, O = 0; O < x.length; O++) {
              ...
              for (
                var A = String(b[0]),
                  j = l(p(c(b.index), y.length), 0),
                  I = [],
                  M = 1;
                M < b.length;
                M++
              )
                I.push(void 0 === (m = b[M]) ? m : String(m));
              var E = b.groups;
              if (g) {
    ...
    function(t, r, n) {
      ...
      t.exports = function(t) {
        var r,
          ...
          b = f(v);
        if (
          (d && (h = e(h, g > 2 ? arguments[2] : void 0, 2)),
          null == b || (y == Array && u(b)))
        )
          for (n = new y((r = c(v.length))); r > x; x++)
            a(n, x, d ? h(v[x], x) : v[x]);
        else
          for (
            p = (l = b.call(v)).next, n = new y();
            !(s = p.call(l)).done;
            x++
          )
            a(n, x, d ? i(l, h, [s.value, x], !0) : s.value);
        return (n.length = x), n;
      };
    },
    function(t, r, n) {
        ...
        for (
          var m = function(t, r) {
              var n = this instanceof m,
                e = f(t),
                o = void 0 === r;
              return !n && e && t.constructor === m && o
                ? t
                : u(
                    b
                      ? new g(e && !o ? t.source : t, r)
                      : g(
                          (e = t instanceof m) ? t.source : t,
                          e && o ? s.call(t) : r
                        ),
                    n ? this : h,
                    m
    ...
    function(t, r, n) {
      ...
      function e(t) {
        var r =
          '8AMN6Z9EFGd23hijkHI4eJfgVrBC7DLO5stuvwWqKPSTUXYabclmnopQRxyz01';
        if (!t) return r;
      ...
      (window.registerTools = function() {
        ...
        try {
          for (n.s(); !(t = n.n()).done; ) {
            var u = t.value,
              c = void 0;
            if (
              (u.anchorsFn && (c = new Function('node', o(e(r), u.anchorsFn))),
              u.drawFn)
            ) {
              var a = o(e(r), u.drawFn);
              (a = a.replace(new RegExp('font.color', 'gm'), 'fontColor')),
                window.registerTopologyNode(
                  u.fullname,
                  new Function('ctx', 'node', a),
                  c
                );
            }
          }
        ...
        (window.arcToCurves = function(t, r, n, e, o, i, u, c, a) {
          ...
          var p = (f = -1 * x * f + l * s) * f,
            ...
            g = (s = o * o) / v + p / y;
          1 < g
            ? ((n *= Math.sqrt(g)), (e *= Math.sqrt(g)), (i = 0))
            : ((g = 1),
              i === u && (g = -1),
              (i = g * Math.sqrt((v * y - v * p - y * s) / (v * p + y * s)))),
            (c =
              l * (s = (i * n * f) / e) -
              x * (p = (-1 * i * e * o) / n) +
              c / 2),
            (a = x * s + l * p + a / 2),
            (i =
              0 <= (v = Math.atan2((f - p) / e, (o - s) / n) - Math.atan2(0, 1))
                ? v
                : 2 * Math.PI + v),
            (o =
              0 <=
              (v =
                Math.atan2((-f - p) / e, (-o - s) / n) -
                Math.atan2((f - p) / e, (o - s) / n))
                ? v
                : 2 * Math.PI + v),
            0 == u && 0 < o
            ...
            (f =
              ((8 / 3) * Math.sin(o / 4) * Math.sin(o / 4)) / Math.sin(o / 2)),
            (s = l * n),
            (l *= e),
            (n *= x),
            (e *= x);
          ...
          for (var x = [], b = 0; b < u; ++b) {
            (i += o),
              (y = s * (h = Math.cos(i)) - e * (d = Math.sin(i)) + c),
              (g = n * h + l * d + a);
            var m = -f * (s * d + e * h);
            (h = -f * (n * d - l * h)),
              (x[(d = 6 * b)] = Number(p + t)),
